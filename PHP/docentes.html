                        ...
                        <div class="swiper-wrapper">
                            ...
                            <article class="card__article swiper-slide">
                                ...
                                <div class="card__data">
                                    <h3 class="card__name">Dr. Camilo Rivera Ledesma</h3>
                                    <p class="card__description">El Dr. Camilo Rivera Ledesma es un docente con más de
                                        15 años de experiencia en la enseñanza y el desarrollo de software. Es
                                        reconocido por su enfoque innovador en la programación con Python.</p>
                                </div>
                            </article>
