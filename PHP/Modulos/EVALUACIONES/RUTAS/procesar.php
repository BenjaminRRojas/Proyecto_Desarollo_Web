...
if ($accion == 'agregar') {
    ...
    if ($controlador->agregarEvaluacion($titulo, $descripcion, $fecha_creacion, $fecha_limite, $id_curso)) {
    ...
    $controlador->actualizarEvaluacion($_POST['id_evaluacion'], $_POST['titulo'], $_POST['descripcion'], $_POST['fecha_creacion'], $_POST['fecha_limite'], $_POST['id_curso']);
